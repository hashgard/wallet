const en = {
  ...
  Mine:{
    dapp:'Dapp',
    MysteriousMIne:'Gold Rush Age',
    MineID:'Mine ID',
    StartingHeight:'Starting Height',
    Status:'Status',
    OccupationPeriod:'Occupation Period',
    MiningPeriod:'Mining Period',
    HarvestPeriod:'Harvest Period',
    Occupy:'Occupy',
    Enter:'Enter',
    Harvest:'Harvest',
    notParticipated:'You have not participated in the occupation or investment of this mining pool!',
    haveClaimed:'You have claimed the rewards generated from this mining pool!',
    None:'None',
    SuccessfullyOccupied:'Congratulations! You have successfully occupied the first mining pool of {name}th round.',
    ClicktoHarvest:'Click to Harvest',
    Harvesthistory:'History',
    Miningprogress:'Mining progress',
    MineOwner:'Mine Owner',
    Mine:'Mine',
    Openformining:'Open for mining',
    Openforoccupation:'Open for occupation',
    Occupytheminingpool:'Occupy the mining pool',
    Balance:'Balance',
    Enterthepassword:'Enter the password',
    Confirm:'Confirm',
    Investmentquota:'Investment quota',
    Investmentamount:'Investment amount',
    Incorrectinvestmentamount:'Incorrect investment amount',
    Keepminingnow:'Investment succeeded. Keep mining now!',
    MiningpoolID:'Mining pool ID',
    TotalInvestment:'Total Investment',
    Occupationcost:'Occupation cost',
    Miningpoolinitialvalue:'Mining pool initial value',
    Investors:'Investors',
    Investmentamount:'Investment amount',
    ReliefFundspool:'Relief Funds pool',
    ActualInvestmentamount:'Actual Investment amount',
    Valuevariation:'Value variation',
    HowtoPlay:'How to Play?',
    AboutInvestmentRewards:'About Investment Rewards',
    poolshavebeenoccupied:'The 9 pools have been occupied. Please wait for the new mining!',
    miningperiodover:'You have no access to mining as the mining period is already over. ',
    maximumlimit:"You can't invest in the mining pool as it has reached its maximum investment limit. ",
    lessthan:"You can't invest in the mining as less than 2 pools are occupied.",
    tableTotal:'Total: {name}',
    wait:'Please wait for the new mining!',
    feeNo:'The balance is not enough',
    Miningisnotallowed:'Mining is not allowed before the end of the occupation period'
  }
};
export default en;